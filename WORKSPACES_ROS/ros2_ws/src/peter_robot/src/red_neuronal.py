...
class NetworkPublisher(Node):
    ...
    def __init__(self):
        ...
        # Valor inicial sensores
        self.imu_data = None
        self.lidar_data = None
        self.bumpRU_data = None
        self.bumpRD_data = None
        self.bumpLU_data = None
        self.bumpLD_data = None
    ...
    def imu_callback(self, msg):
        """Callback para el IMU: almacena la orientación del sensor."""

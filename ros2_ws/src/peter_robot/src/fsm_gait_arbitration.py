...
class FSMGaitArbitration(Node):

    def __init__(self):
        super().__init__('fsm_gait_arbitration')
    ...
    def run_network(self):
        ...
        # FSM: z[14]/z[15]/z[16] no se integran dinámicamente.
        # El arbitraje de modo lo realiza la FSM en el bloque de publicación.
        self.z[14, 1] = 0.0
        self.z[15, 1] = 0.0
        self.z[16, 1] = 0.0
    ...
    #------------------------- TERRAIN CHANGER -----------------------------
        ...
        if self.MOVEMENT:
            ...
            elif lat != 0.0 and self.current_mode != 'H':
